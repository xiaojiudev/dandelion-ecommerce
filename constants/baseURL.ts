...
export const USER_WISHLIST_URI = "/user/wishlist";


export const DEFAULT_IMG_URL = 'https://res.cloudinary.com/de8xbko8y/image/upload/v1703173779/uploads/9214769_dgwtc4.jpg';        
